...
public class EconomyManager implements Module {
    ...
    public void loadConfigurations() {
        MessagesConfiguration messagesConfiguration = new MessagesConfiguration(plugin.messages());
        ...
        EterniaLib.getCfgManager().registerConfiguration("eterniaserver", "economy", true, configuration);
        EterniaLib.getCfgManager().registerConfiguration("eterniaserver", "economy_messages", true, messagesConfiguration);
        EterniaLib.getCfgManager().registerConfiguration("eterniaserver", "economy_commands", true, commandsConfiguration);
        ...
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, "Economy module: {0}", exception.getMessage());
            return;
        }
