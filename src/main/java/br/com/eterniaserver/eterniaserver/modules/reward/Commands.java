...
final class Commands {
    ...
    static class Rewards extends BaseCommand {
        ...
        public void onUseKey(Player player, String key) {
            ...
            if (reward == null) {
                MessageOptions messageOptions = new MessageOptions(key);
                EterniaLib.getChatCommons().sendMessage(player, Messages.REWARD_INVALID_KEY, messageOptions);
                return;
            }
        ...
        public void onGenKey(CommandSender sender, String reward) {
            ...
            MessageOptions messageOptions = new MessageOptions(key);
            EterniaLib.getChatCommons().sendMessage(sender, Messages.REWARD_CREATED, messageOptions);
        }
