...
final class Configurations {
    ...
    static class SpawnerMessagesConfiguration implements MsgConfiguration<Messages> {
        ...
        public SpawnerMessagesConfiguration(MessageMap<Messages, String> messageMap) {
        ...
        public void executeConfig() {
            addMessage(Messages.SPAWNER_INV_FULL,
                    "O inventário do jogador está cheio#555555."
            );
            addMessage(Messages.SPAWNER_RECEIVED,
                    "Você recebeu #00aaaa{3}#aaaaaa spawner de #00aaaa{0}#aaaaaa por #00aaaa{2}#555555.",
                    "mob",
                    "nome do jogador",
                    "apelido do jogador",
                    "quantia"
            ...
            addMessage(Messages.SPAWNER_SENT,
                    "Você enviou #00aaaa{3}#aaaaaa spawner de #00aaaa{0}#aaaaaa para #00aaaa{2}#555555.",
                    "mob",
                    "nome do jogador",
                    "apelido do jogador",
                    "quantia"
            ...
            addMessage(Messages.SPAWNER_SEND_TYPES,
                    "Os tipos de spawners válidos são#555555: #00aaaa{0}#555555.",
                    "tipos"
            );
            addMessage(Messages.SPAWNER_CANT_CHANGE_NAME,
                    "Você não pode renomear spawners#555555."
            );
            addMessage(Messages.SPAWNER_WORLD_BLOCKED,
                    "Você não pode quebrar spawners nesse mundo#555555."
            );
            addMessage(Messages.SPAWNER_DROP_FAILED,
                    "Não foi dessa vez#555555."
            );
            addMessage(Messages.SPAWNER_SILK_REQUESTED,
                    "Você precisa de uma picareta com toque suave para isso#555555."
            );
    ...
    static class SpawnerCommandsConfiguration implements CmdConfiguration<Enums.Commands> {
    ...
    static class SpawnerConfiguration implements ReloadableConfiguration {
        ...
        public void executeConfig() {
            ...
            // Strings
            strings[Strings.MINI_MESSAGES_ENTITIES_DIVIDER.ordinal()] = inFile.getString("mini-messages.entities-divider", "#555555, #00aaaa");
            strings[Strings.MINI_MESSAGES_SPAWNERS_FORMAT.ordinal()] = inFile.getString("mini-messages.spawners-format", "#555555[#926CEB%spawner_name% #aaaaaaSpawner#555555]");
